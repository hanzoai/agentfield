...
| [rag_evaluation](python_agent_nodes/rag_evaluation/) | Multi-metric QA assessment | Faithfulness, Relevance, Hallucination detection, Constitutional checks. [Full documentation →](https://agentfield.dev/examples/complete-agents/rag-evaluator) |
